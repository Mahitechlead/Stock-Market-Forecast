...
# Author name
st.write('<p style="color:white; font-size: 30px;">Mahi Saxena</br></p>', unsafe_allow_html=True)

st.write('# About the Contributer:')

st.write('<p style="color:white; font-size: 30px;">Akshay Pratap Singh, Kriti Dwivedi, Aditya Verma, Anuj Katiyar</p>', unsafe_allow_html=True)
